...
/**
 * Assistant auth endpoints.
 */
@RestController
@RequestMapping("/assistant")
public class OsgAssistantAuthController
{
    @Autowired
    ...
    public AjaxResult login(@RequestBody LoginBody loginBody)
    {
        ...
        SysUser user = assistantAccessService.findUserByLogin(loginName);
        if (user != null && !assistantAccessService.hasAssistantAccess(user))
        {
            return AjaxResult.error(HttpStatus.FORBIDDEN, "该账号无助教端访问权限");
        }
