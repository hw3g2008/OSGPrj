...
/**
 * Admin 端求职总览 Controller。
 * 由 OsgJobOverviewController（拆分前）抽取的 admin 端方法构成。
 * URL 前缀：/admin/job-overview/*
 */
@RestController
@RequestMapping("/admin/job-overview")
public class OsgAdminJobOverviewController extends BaseController
{
