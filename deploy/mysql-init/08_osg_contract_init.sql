...
CREATE TABLE IF NOT EXISTS osg_contract (
  ...
  contract_amount     DECIMAL(10,2)  NOT NULL DEFAULT 0.00 COMMENT '合同金额（总金额=美元+英镑等值）',
  currency            VARCHAR(10)    NOT NULL DEFAULT 'USD' COMMENT '币种: USD/GBP',
  amount_usd          DECIMAL(12,2)  DEFAULT NULL COMMENT '美元金额',
  amount_gbp          DECIMAL(12,2)  DEFAULT NULL COMMENT '英镑金额',
