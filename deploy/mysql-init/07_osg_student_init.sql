...
CREATE TABLE IF NOT EXISTS osg_student (
  ...
  major_direction    VARCHAR(255)  DEFAULT NULL COMMENT '主攻方向(多选 dict_value，逗号分隔)',
  sub_direction      VARCHAR(64)   DEFAULT NULL COMMENT '子方向',
  target_region      VARCHAR(255)  DEFAULT NULL COMMENT '求职地区(多选大区，逗号分隔)',
  recruitment_cycle  VARCHAR(255)  DEFAULT NULL COMMENT '招聘周期(多选，逗号分隔)',
